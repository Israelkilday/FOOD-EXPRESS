...
import UseToggleFavoriteResrtaurant from "@/app/_hooks/use-toggle-favorite-restaurants";
...
const RestaurantImage = ({
  ...
  const { handleFavoriteClick } = UseToggleFavoriteResrtaurant({
  ...
  return (
    <div className="relative h-[250px] w-full lg:h-[300px] ">
      <Image
